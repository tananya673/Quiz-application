...
public class Quiz extends JFrame implements ActionListener {
    ...
    public static boolean isScoreShown = false;
    ...
    Quiz(String name) {
        ...
        ImageIcon i1 = new ImageIcon("C:\\Users\\Ananya Thakur\\OneDrive\\Desktop\\mca\\java_project\\quizp.png");
        ...
        next.setBounds(780, 590, 160, 45); // bigger button
        next.setBackground(new Color(0, 51, 102)); // medium turquoise
        next.setForeground(Color.white); // better contrast
        next.setFont(new Font("Tahoma", Font.BOLD, 18)); // better readability
        next.setFocusPainted(false); // removes border highlight
        next.addActionListener(this);
        image.add(next);

        submit = new JButton("Submit");
        submit.setBounds(780, 590, 160, 45); // bigger button
        submit.setBackground(new Color(0, 51, 102)); // medium turquoise
        submit.setForeground(Color.white); // better contrast
        submit.setFont(new Font("Tahoma", Font.BOLD, 18)); // better readability
        submit.setFocusPainted(false); // removes border highlight
